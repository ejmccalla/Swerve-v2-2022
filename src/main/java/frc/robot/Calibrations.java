...
public final class Calibrations {
     ...
     * @implNote This should be done before each event minimum.
     */
    public static final double TRACK_WIDTH_INCH = 18.0;
     ...
     * @implNote This should be done before each event minimum.
     */
    public static final double WHEEL_BASE_INCH = 17.125;
     ...
     */
    public static final double TURN_P_GAIN = 0.7;
     ...
     * @implNote This should be tuned before each event minimum.
     */
    public static final double TURN_D_GAIN = 0.01;
     ...
     * @implNote This should be tuned before each event minimum.
     */
    public static final double MAX_TURN_ERROR_DEG = 3.0;
     ...
     * @implNote This should be tuned before each event minimum.
     */
    public static final double DRIVE_P_GAIN = 0.1;
     ...
     *
     * @implNote This should be increased towards maximim as drivers improve.
     */
